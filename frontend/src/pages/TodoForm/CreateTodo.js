  ...
  return (
    <div className='page formTodoPage'>
      ...
      <section className='container'>
        <h1 className="title"><span>Create Todo</span><i className="fa fa-calendar-plus-o" aria-hidden="true"></i></h1>
        <form ref={formRef} className='todoForm' onSubmit={(e) => e.preventDefault()}>
          ...
          <button onClick={createTodo} className='addTodo'>Create Todo</button>
        </form>
      </section>
    </div> 
  )
